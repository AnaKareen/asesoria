...
include_once __DIR__ . '\..\controladores\empresas.php';
?>
<!DOCTYPE html>
<html lang="es">

<?php include_once __DIR__.'\\..\\h&f\\head.php'?>
<title>PI ASESESORIA | Listado de Empresas</title>
<body>
    ...
    <section id="content">
        ...
        <main>
            ...
            <a href="../controladores/empresas.php?action=CREATE" class="button">Nuevo</a>
            <div class="data">
                                    ...
                                    <?php foreach ($datos as $dato): ?>
                                        <tr>
                                            ...
                                            <div class="btn-group" role="group">
                                                <a href="../controladores/empresas.php?action=UPDATE&id_empresa=<?php echo $dato['id_empresa']; ?>"
                                                class="bg-green-500 hover:bg-green-700 text-white font-bold py-2 px-4 rounded">Actualizar</a>
                                                <a href="../controladores/empresas.php?action=DELETE&id_empresa=<?php echo $dato['id_empresa']; ?>"
