...
<title>PI ASESESORIA | Listado de Departamentos</title>
<body>
    ...
    <section id="content">
        ...
        <main>
            ...
            <a href="../controladores/departamento.php?action=CREATE" class="button">Nuevo</a>
            <div class="data">
                            ...
                            <table id="example" class="responsive-table">
                                ...
                                <tbody>
                                    <?php foreach ($datos as $dato): ?>
                                        <tr>
                                            <th scope="row"><?php echo $dato['id_departamento']; ?></th>
                                            <td><?php echo $dato['nombre']; ?></td>
                                            <td><?php echo $dato['empresa']; ?></td>
                                            <td>
                                            <div class="btn-group" role="group">
                                                <a href="../controladores/departamento.php?action=UPDATE&id_departamento=<?php echo $dato['id_departamento']; ?>"
                                                class="bg-green-500 hover:bg-green-700 text-white font-bold py-2 px-4 rounded">Actualizar</a>
                                                <a href="../controladores/departamento.php?action=DELETE&id_departamento=<?php echo $dato['id_departamento']; ?>"
